...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern>
    <rule context="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:IssueDateTime/udt:DateTimeString[@format]">
      ...
      <!-- NEW -->
      <assert test="$codeValue2 = '102'">
	Value of '@format' is not allowed. (only 102 is)</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <rule context="/rsm:CrossIndustryInvoice/rsm:ExchangedDocument/ram:TypeCode">
      ...
      <!-- NEW -->
      <assert test="$codeValue1 = '380' or $codeValue1 = '381' or $codeValue1 = '384' or $codeValue1 = '386'">
	The TypeCode value must be one of the following: 380 (Invoice), 381 (Credit note), 384 (Corrected Invoice), 386 (Advance Invoice).</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
	...
	Value of '@schemeID' is not allowed.</assert> -->
      <!-- NEW -->
      <assert test="$codeValue5 = '0002'">
	Value of '@schemeID' is not allowed, only 0002 is (SIREN)</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
	...
	Value of '@schemeID' is not allowed.</assert> -->
      <assert test="$codeValue4 = 'FC' or $codeValue4 = 'VA'">
	Value of '@schemeID' is not allowed.</assert>
    </rule>
  </pattern>
  <pattern>
  ...
  <assert test="$codeValue6 = 'EUR'">
	Value of '@currencyID' is not allowed. (only EUR is)</assert>
    </rule>
  </pattern>
  <pattern>
